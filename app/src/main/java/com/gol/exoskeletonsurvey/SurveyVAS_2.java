...
public class SurveyVAS_2 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_vas_2);
        seekBar = findViewById(R.id.seekBar);
        seekBar.setOnSeekBarChangeListener(new SurveyVAS_2.seekListener());
        ...
        question_used.put(1, true);
        other_question = question_used.get(0);
        if (other_question){
    ...
    public void nextQuestion(View view) {
        ...
        dictionary.put("VAS_2", seekBar.getProgress());

        if (!other_question) {
            Intent q22q2 = new Intent(SurveyVAS_2.this, SurveyVAS_1.class);
            q22q2.putExtra("schoolID", schoolID);
            q22q2.putExtra("subjectID", subjectID_string);
            q22q2.putExtra("questionUsed", question_used);
            q22q2.putExtra("dictionary", dictionary);
            startActivity(q22q2);
    ...
    public void send_button() {
        ...
        Intent Survey2End = new Intent(SurveyVAS_2.this, End.class);
